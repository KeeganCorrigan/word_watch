...
__WEBPACK_IMPORTED_MODULE_0_jquery___default()(document).ready(() => {
  getTopWord();
  __WEBPACK_IMPORTED_MODULE_0_jquery___default()("#break-down-btn").click(submitText);
})
...
const submitText = (event) => {
  ...
  let text = __WEBPACK_IMPORTED_MODULE_0_jquery___default()("#textarea-submission").val();
...
const clearTextArea = () => {
  __WEBPACK_IMPORTED_MODULE_0_jquery___default()("#textarea-submission").val(" ")
};

const refreshFavoriteWord = () => {
  __WEBPACK_IMPORTED_MODULE_0_jquery___default()("#top-word-container").empty()
}
...
const findTopWord = (word) => {
  ...
  __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#top-word-container').html(`
    <p> ${top_word} </p>
    <p> ${top_word_count} </p>
    `)
}
